...
@Component
public class HubAttachStoreImpl implements HubAttachStore {
    private final MinioHelper minioHelper;
    private final MinioProperties minioProperties;

    @Override
    public void upload(MultipartFile multipartFile, HubAttach attach) throws Exception {
        minioHelper.upload(multipartFile, attach.getTenantId(), attach.getAttachPath(), YES == attach.getIsPrivate());
    }

    @Override
    public void download(HttpServletResponse response, HubAttach attach) throws Exception {
    ...
    @Override
    public void remove(HubAttach attach) throws Exception {
