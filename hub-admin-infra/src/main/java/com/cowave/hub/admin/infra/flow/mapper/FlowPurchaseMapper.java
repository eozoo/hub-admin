 ...
 */
@Mapper
public interface FlowPurchaseMapper extends BaseMapper<FlowPurchase> {

    /**
     * 列表
     */
    Page<PurchaseInfoPto> list(Page<PurchaseInfoPto> page, @Param("purchase") PurchaseInfoPto purchaseInfoPto);
