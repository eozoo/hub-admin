...
import com.cowave.hub.admin.domain.sys.repository.HubAlarmRepository;
 ...
 */
@Repository
public class HubAlarmDao extends ServiceImpl<HubAlarmMapper, HubAlarm> implements HubAlarmRepository {
    ...
    @Override
    public HubAlarm queryAlarmExistsByTypeId(Long typeId) {
        return baseMapper.selectOne(new LambdaQueryWrapper<HubAlarm>()
                .eq(HubAlarm::getAlarmType, typeId).last("limit 1"));
    }
