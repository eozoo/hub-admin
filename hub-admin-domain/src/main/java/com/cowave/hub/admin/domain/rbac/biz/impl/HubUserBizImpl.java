...
public class HubUserBizImpl implements HubUserBiz {
    ...
    public void saveUserDiagram(Integer userId, Integer parentId, String tenantId) {
        userRepository.saveUserDiagramBatch(List.of(new HubUserDiagram(userId, parentId, tenantId)));
    }

    @Override
    public void saveUserRole(Integer userId, Integer roleId) {
        userRepository.saveUserRolesBatch(List.of(new HubUserRole(userId, roleId)));
    }

    @Override
    public void createTenantManager(HubUser hubUser) {
        userRepository.save(hubUser);
    }
    ...
    @Override
    public void updateLdapUser(HubUser hubUser) {
        userRepository.updateLdapByCode(hubUser);
    }

    @Override
    public void updateGitlabUser(HubUser hubUser) {
        userRepository.updateGitlabByCode(hubUser);
    }
}
