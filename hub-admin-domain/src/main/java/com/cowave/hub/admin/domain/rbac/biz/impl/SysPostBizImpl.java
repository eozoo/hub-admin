...
import com.cowave.hub.admin.domain.rbac.biz.SysPostBiz;
...
public class SysPostBizImpl implements SysPostBiz {
    ...
    public void deletePosts(String tenantId, List<Integer> postIds) {
        ...
        List<SysPost> list = postRepository.queryListByIds(tenantId, postIds);
    ...
    private void inputPostParents(String tenantId, PostCreate post, boolean overwrite) {
        ...
        postRepository.saveDiagram(new SysPostDiagram(post.getPostId(), parentId, tenantId));
    }
}
