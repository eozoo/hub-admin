...
public class SysDeptBizImpl implements SysDeptBiz {
    ...
    public void deleteDepts(String tenantId, List<Integer> deptIds) {
        ...
        List<SysDept> list = deptRepository.queryListOfTenantByIds(tenantId, deptIds);
    ...
    public void addPosts(String tenantId, List<SysDeptPost> list) {
        ...
        List<SysDeptPost> insertList = deptRepository.queryDeptPosts(list);
    ...
    public void removePosts(String tenantId, Integer deptId, List<Integer> postIds) {
        ...
        SysDept sysDept = deptRepository.queryOfTenantById(tenantId, deptId);
