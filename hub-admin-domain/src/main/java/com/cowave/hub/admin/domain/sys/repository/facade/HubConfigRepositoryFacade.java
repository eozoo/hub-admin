 ...
 * @author shanhuiming
 */
public interface HubConfigRepositoryFacade {

    /**
     * 分页查询
     */
    Page<HubConfig> queryPage(String tenantId, ConfigQuery query);

    /**
     * 列表查询
     */
    List<HubConfig> queryList(String tenantId, ConfigQuery query);

    /**
     * 详情
     */
    HubConfig queryById(String tenantId, Integer configId);
