...
import com.cowave.hub.admin.domain.sys.repository.facade.HubAlarmRepositoryFacade;

/**
 * @author shanhuiming
 */
public interface HubAlarmRepository extends HubAlarmRepositoryFacade, IService<HubAlarm> {
