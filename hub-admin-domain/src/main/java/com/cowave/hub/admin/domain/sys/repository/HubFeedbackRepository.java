 ...
 * @author shanhuiming
 */
public interface HubFeedbackRepository extends HubFeedbackRepositoryFacade, IService<HubFeedback> {
     ...
     * 评论详情
     */
    HubFeedbackComment getComment(Long commentId);

    /**
     * 新增评论
     */
    void saveComment(HubFeedbackComment comment);
     ...
     * 点赞
     */
    void saveLike(HubFeedbackLike like);
