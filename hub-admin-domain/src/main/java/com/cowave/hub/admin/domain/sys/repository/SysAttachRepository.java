 ...
 * @author shanhuiming
 */
public interface SysAttachRepository extends SysAttachRepositoryFacade, IService<SysAttach> {

    /**
     * 宿主最新附件
     */
    SysAttach queryLatestByOwner(String ownerId, String ownerModule, AttachType attachType);
