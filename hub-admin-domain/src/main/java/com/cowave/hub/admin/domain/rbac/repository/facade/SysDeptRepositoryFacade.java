 ...
 * @author shanhuiming
 */
public interface SysDeptRepositoryFacade {

    /**
     * 部门查询（部门id）
     */
    SysDept queryOfTenantById(String tenantId, Integer deptId);

    /**
     * 部门列表
     */
    List<SysDept> queryListOfTenant(String tenantId);

    /**
     * 部门列表（部门id）
     */
    List<SysDept> queryListOfTenantByIds(String tenantId, List<Integer> deptIds);
