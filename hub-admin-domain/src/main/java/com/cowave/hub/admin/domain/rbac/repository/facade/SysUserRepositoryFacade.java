...
public interface SysUserRepositoryFacade {
     ...
     * 导出列表
     */
    List<SysUser> queryListForExport(String tenantId, UserExportQuery query);
     ...
     * 按账号查询
     */
    SysUser queryByAccount(String tenantId, UserType userType, String userAccount);

    /**
     * 按编码查询
     */
    SysUser queryByCode(String userCode);
