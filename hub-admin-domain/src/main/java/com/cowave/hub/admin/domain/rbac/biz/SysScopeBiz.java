 ...
 * @author shanhuiming
 */
public interface SysScopeBiz {

    /**
     * 新增
     */
    void createScope(String tenantId, SysScope sysScope);

    /**
     * 删除
     */
    void deleteScopes(String tenantId, List<Integer> scopeIds);

    /**
     * 修改名称
     */
    void editName(String tenantId, ScopeNameUpdate nameUpdate);
