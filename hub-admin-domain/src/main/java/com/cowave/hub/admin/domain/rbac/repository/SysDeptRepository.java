 ...
 * @author shanhuiming
 */
public interface SysDeptRepository extends SysDeptRepositoryFacade, IService<SysDept> {
     ...
     * 批量新增上下级关系
     */
    void saveDiagramBatch(List<SysDeptDiagram> list);
     ...
     * 插入部门岗位
     */
    void insertDeptPosts(String tenantId, List<SysDeptPost> list);
     ...
     * 插入部门人员
     */
    void insertDeptUsers(String tenantId, List<SysUserDept> list);
