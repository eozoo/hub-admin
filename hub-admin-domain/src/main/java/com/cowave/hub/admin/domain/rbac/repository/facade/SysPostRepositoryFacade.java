 ...
 * @author shanhuiming
 */
public interface SysPostRepositoryFacade {

    /**
     * 分页列表
     */
    Page<SysPost> queryPage(String tenantId, DeptPostQuery query);

    /**
     * 列表
     */
    List<SysPost> queryList(String tenantId, DeptPostQuery query);

    /**
     * 列表（岗位id）
     */
    List<SysPost> queryListByIds(String tenantId, List<Integer> postIds);
