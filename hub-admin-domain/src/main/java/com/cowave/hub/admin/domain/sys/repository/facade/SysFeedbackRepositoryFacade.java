 ...
 *
 * @see SysFeedback
 * @see SysFeedbackComment
 * @see SysFeedbackLike
 *
 * @author shanhuiming
 */
public interface SysFeedbackRepositoryFacade {
     ...
     * 留言列表
     */
    Page<SysFeedback> queryPage(String tenantId, FeedbackQuery query);

    /**
     * 留言评论列表
     */
    List<SysFeedbackComment> listComments(Long feedbackId);
     ...
     * 给目标点赞的用户列表
     */
    List<SysFeedbackLike> listLikes(int targetType, Long targetId);
}
