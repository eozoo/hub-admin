 ...
 * @author shanhuiming
 */
public interface FlowLeaveRepository extends FlowLeaveRepositoryFacade, IService<FlowLeave> {

    void insert(FlowLeave flowLeave);

    int update(FlowLeave flowLeave);
