 ...
 * @author shanhuiming
 */
public interface SysNoticeRepository extends SysNoticeRepositoryFacade, IService<SysNotice> {
     ...
     * 评论详情
     */
    SysNoticeComment getComment(Long commentId);

    /**
     * 新增评论
     */
    void saveComment(SysNoticeComment comment);
     ...
     * 点赞
     */
    void saveLike(SysNoticeLike like);
