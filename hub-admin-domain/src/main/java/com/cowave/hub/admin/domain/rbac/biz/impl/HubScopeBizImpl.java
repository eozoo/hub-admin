...
public class HubScopeBizImpl implements HubScopeBiz {

    private final HubScopeRepository scopeRepository;

    @Override
    public void createScope(String tenantId, HubScope hubScope) {
        hubScope.setTenantId(tenantId);
        scopeRepository.save(hubScope);
    }
