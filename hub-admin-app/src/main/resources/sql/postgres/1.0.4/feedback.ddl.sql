...
comment on column sys_feedback.id is '主键';
comment on column sys_feedback.tenant_id is '租户id';
comment on column sys_feedback.user_code is '用户账号';
comment on column sys_feedback.user_name is '用户名称';
comment on column sys_feedback.score is '评分 1-5';
comment on column sys_feedback.content is '留言内容';
comment on column sys_feedback.like_count is '点赞数';
comment on column sys_feedback.reply_count is '评论数';
comment on column sys_feedback.images is '图片url列表，逗号分隔';
...
comment on column sys_feedback_comment.id is '主键';
...
comment on column sys_feedback_comment.reply_to_code is '被回复用户账号';
comment on column sys_feedback_comment.reply_to_name is '被回复用户名称';
comment on column sys_feedback_comment.user_code is '评论者账号';
comment on column sys_feedback_comment.user_name is '评论者名称';
comment on column sys_feedback_comment.content is '评论内容';
comment on column sys_feedback_comment.like_count is '点赞数';
...
comment on column sys_feedback_like.id is '主键';
comment on column sys_feedback_like.target_type is '目标类型 1-留言 2-评论';
comment on column sys_feedback_like.target_id is '目标id';
comment on column sys_feedback_like.user_code is '点赞用户账号';
comment on column sys_feedback_like.user_name is '点赞用户名称';
