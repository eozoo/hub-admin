...
(
    ...
    app_type      varchar(64) comment '应用类型 oauth/link',
    app_visible   varchar(64) comment '可见性 public/all/sys',
    link_url      varchar(256) comment '跳转地址',
    app_sort      int default 0 comment '排序',
    status        smallint default 1 comment '状态 0关闭 1开启',
