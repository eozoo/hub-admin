...
public class HubPostController {
	...
	public Response<Void> create(@Validated @RequestBody PostCreate post) {
		hubPostService.create(Access.tenantId(), post);
	...
	public Response<Void> delete(@PathVariable List<Integer> postIds) {
		hubPostService.delete(Access.tenantId(), postIds);
		return Response.success();
	}
	...
	public Response<Void> edit(@Validated @RequestBody PostCreate post) {
		hubPostService.edit(Access.tenantId(), post);
		return Response.success();
	}
	...
	public Response<Tree<Integer>> getDiagram() {
		return Response.success(hubPostService.queryDiagram(Access.tenantId()));
	}
	...
	public Response<List<UserNamePto>> getCandidatesByCode(@PathVariable String postCode) {
		return Response.success(hubPostService.queryCandidatesByCode(Access.tenantId(), postCode));
	}
    ...
    public Response<String> getNameById(@PathVariable Integer postId) {
        return Response.success(hubPostService.queryNameById(Access.tenantId(), postId));
    }
    ...
    public Response<List<String>> getNameOfDeptPost(@PathVariable List<String> deptPosts) {
        return Response.success(hubPostService.queryNameOfDeptPost(Access.tenantId(), deptPosts));
    }
}
