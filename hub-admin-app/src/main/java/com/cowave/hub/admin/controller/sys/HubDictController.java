...
public class HubDictController {
	...
	public Response<Void> edit(@RequestBody DictCreate dictCreate) {
		hubDictService.edit(dictCreate);
		return Response.success();
	}
	...
	public Response<HubDict> getByCode(@PathVariable String dictCode) {
		return Response.success(hubDictService.queryByCode(dictCode));
	}
	...
	public Response<List<HubDict>> listByType(@PathVariable String typeCode) {
		return Response.success(hubDictService.queryListByType(typeCode));
	}
	...
	public Response<List<HubDict>> listByGroup(@PathVariable String groupCode) {
		return Response.success(hubDictService.queryListByGroup(groupCode));
	}
	...
	public Response<Collection<SelectOptionVo>> listTypeByGroup(@PathVariable String groupCode) {
		return Response.success(hubDictService.queryListTypeByGroup(groupCode));
	}
}
