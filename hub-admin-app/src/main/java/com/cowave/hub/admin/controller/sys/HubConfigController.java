...
public class HubConfigController {
    ...
    private final HubConfigService configService;
    ...
    @PostMapping
    public Response<Void> create(@RequestBody HubConfig hubConfig) {
        configService.add(hubConfig);
    ...
    @PatchMapping
    public Response<Void> edit(@RequestBody HubConfig hubConfig) {
        configService.edit(hubConfig);
        return Response.success();
    }
    ...
    public void export(HttpServletResponse response, ConfigQuery query) throws IOException {
        ...
        List<HubConfig> configList = configService.list(Access.tenantId(), query);
