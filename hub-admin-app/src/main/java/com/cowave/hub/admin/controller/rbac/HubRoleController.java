...
public class HubRoleController {
    ...
    @PostMapping
    public Response<Void> add(@Validated @RequestBody HubRole role) {
        hubRoleService.add(Access.tenantId(), role);
    ...
    public Response<Void> delete(@PathVariable List<Integer> roleIds) {
        hubRoleService.delete(Access.tenantId(), roleIds);
        return Response.success();
    }
    ...
    @PatchMapping
    public Response<Void> edit(@Validated @RequestBody HubRole role) {
        hubRoleService.edit(Access.tenantId(), role);
        return Response.success();
    }
    ...
    public Response<Void> updateMenus(@RequestBody RoleMenuUpdate roleUpdate) {
        hubRoleService.updateMenus(Access.tenantId(), roleUpdate);
        return Response.success();
    }
    ...
    public Response<Void> grantUser(@Validated @RequestBody RoleUserUpdate roleUpdate) {
    	hubRoleService.grantUser(Access.tenantId(), roleUpdate);
    	return Response.success();
    }
    ...
    public Response<Void> cancelUser(@Validated @RequestBody RoleUserUpdate roleUpdate) {
    	hubRoleService.cancelUser(Access.tenantId(), roleUpdate);
    	return Response.success();
    }
    ...
    public Response<Response.Page<RoleUserPto>> getAuthedUser(@Valid RoleUserQuery query) {
    	return Response.page(hubRoleService.queryAuthedUser(Access.tenantId(), query));
    }
    ...
    public Response<Response.Page<RoleUserPto>> getUnAuthedUser(@Valid RoleUserQuery query) {
    	return Response.page(hubRoleService.queryUnAuthedUser(Access.tenantId(), query));
    }
    ...
    public Response<List<String>> getNames(@PathVariable List<Integer> roleIds) {
        return Response.success(hubRoleService.queryNames(Access.tenantId(), roleIds));
    }
}
