...
public class HubFeedbackController {

    private final HubFeedbackService feedbackService;
     ...
     */
    @GetMapping("/like")
    public Response<List<HubFeedbackLike>> likes(@NotNull Integer targetType, @NotNull Long targetId) {
