 ...
 * @author shanhuiming
 */
public interface HubOperationService extends OperationHandler {

	/**
	 * 列表
	 */
	Response.Page<HubOperation> queryPage(String tenantId, OperationQuery query, boolean isPage);
	...
	void saveLog(HubOperation hubOperation);
}
