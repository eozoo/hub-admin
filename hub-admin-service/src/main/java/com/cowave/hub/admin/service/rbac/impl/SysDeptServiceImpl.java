...
import com.cowave.hub.admin.domain.rbac.biz.SysDeptBiz;
...
import com.cowave.hub.admin.domain.rbac.repository.facade.SysDeptRepositoryFacade;
...
public class SysDeptServiceImpl implements SysDeptService {
    ...
    private final SysDeptBiz deptBiz;

    private final SysDeptRepositoryFacade deptRepositoryFacade;
    ...
    @Override
    public List<SysDept> queryListForExport(String tenantId) {
