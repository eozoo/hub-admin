 ...
 */
@Component
public class HubBearerTokenServiceImpl extends BearerTokenServiceImpl {

    private final RedisHelper redisHelper;

    public HubBearerTokenServiceImpl(RedisHelper redisHelper, ObjectMapper objectMapper,
